...
class _donateState extends State<donate> {
  ...
  Future donate(BuildContext cont) async {
    if (name.text == "" || email.text == "" || address.text == "" || mobilenumber.text== "" || item.text == "") {
      ...
      var url = "http://192.168.150.16/localconnect/donate.php";
                    ...
                    children: [
                      ...
                      Text("What would you like to donate?"),
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              border: OutlineInputBorder(),
                              hintText: "Enter your Donation item name"),
                        ),
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text('Donate'),
                          // onPressed: () {
                          //   // await Navigator.of(context).push(MaterialPageRoute(builder: (context)=> DonatorInformation(donorId: donor.id!,),
                          //   // ));
                          //   Fluttertoast.showToast(
